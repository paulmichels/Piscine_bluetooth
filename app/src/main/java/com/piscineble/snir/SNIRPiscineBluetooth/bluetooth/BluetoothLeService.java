...
package com.piscineble.snir.SNIRPiscineBluetooth.bluetooth;
...
public class BluetoothLeService extends Service {
    ...
    public final static String PH_DATA =
            "com.example.bluetooth.le.PH_DATA";
    ...
    public final static UUID UUID_PISCINE_SERVICE =
            UUID.fromString(SampleGattAttributes.PISCINE_SERVICE);
    public final static UUID UUID_ANALOG_MEASUREMENT =
            UUID.fromString(SampleGattAttributes.ANALOG_MEASUREMENT_PH);
    public final static UUID UUID_ANALOG_MEASUREMENT2 =
            UUID.fromString(SampleGattAttributes.ANALOG_MEASUREMENT_TEMPERATURE);
    public final static UUID UUID_ANALOG_MEASUREMENT3 =
    ...
    public void setCharacteristicNotification(BluetoothGattCharacteristic characteristic,
        ...
        if (UUID_ANALOG_MEASUREMENT2.equals(characteristic.getUuid())) {
            BluetoothGattDescriptor descriptor = characteristic.getDescriptor(
                    UUID.fromString(SampleGattAttributes.CLIENT_CHARACTERISTIC_CONFIG));
            descriptor.setValue(BluetoothGattDescriptor.ENABLE_NOTIFICATION_VALUE);
            mBluetoothGatt.writeDescriptor(descriptor);
        }
        if (UUID_ANALOG_MEASUREMENT3.equals(characteristic.getUuid())) {
            BluetoothGattDescriptor descriptor = characteristic.getDescriptor(
                    UUID.fromString(SampleGattAttributes.CLIENT_CHARACTERISTIC_CONFIG));
            descriptor.setValue(BluetoothGattDescriptor.ENABLE_NOTIFICATION_VALUE);
            mBluetoothGatt.writeDescriptor(descriptor);
